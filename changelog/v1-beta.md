...
- [What's New](#whats-new)
  ...
  * [\[ devices \]](#-devices-)
    ...
    + [cableTest](#cabletest)
      - [Enqueue a job to perform a cable test for the device on the specified ports. Only native Catalyst switches are supported.](#enqueue-a-job-to-perform-a-cable-test-for-the-device-on-the-specified-ports-only-native-catalyst-switches-are-supported)
...
Version **1.41.0** _to_ **1.40.0-beta.1**
...
> \- New endpoint
> 
> #### Enqueue a job to perform a cable test for the device on the specified ports. Only native Catalyst switches are supported.
> 
