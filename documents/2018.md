...
* [Integration Merakibeat Elastic Beats plugin for Meraki Wireless Health APIs](https://create.meraki.io/build/merakibeat-elastic-beats-plugin-for-meraki-wireless-health-apis/) - A new Elastic Beats plugin for the Meraki Wireless Health API that makes it easy to boot-strap sending Stats to elasticsearch or any of output service supported by beats.
