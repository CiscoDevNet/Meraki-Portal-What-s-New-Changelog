...
<div class="alert alert-info" role="alert">
  <strong>API change alert:</strong> Organization IDs will be returned as strings instead of integers starting on Monday, June 24th ([details](https://community.meraki.com/t5/Solutions-APIs/Bug-Fix-Organization-ID-type-as-string/td-p/49840))</div>
 </pubhub>
