...
<div class="alert alert-info" role="alert">
  <strong>Note:</strong> Note: Use the new `switchProfileId`
...
<div class="alert alert-info" role="alert">
Note: Use the new `switchProfileId`
parameter in the [Update the attributes of a device](https://api.meraki.com/api_docs#update-the-attributes-of-a-device) endpoint to apply a port profile to a switch
</div>
