...
## 10-2019: Dashboard API Version 0.4.0 Released 
---
### New Endpoints
...
### Enhancements
* Rate limit `429` responses now include a **retry-after header** – [see documentation](https://developer.cisco.com/meraki/api/#/rest/getting-started/rate-limit (edited)) for further details* Monitoring: Show **device firmware version** in [network](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/devices/get-network-devices) and [organization](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/devices/get-organization-devices) devices endpoints via `firmware` attribute
...
## 9-2019: Dashboard API Version 0.3.0 Released
---
### New Endpoints
