...
#### New Endpoints
* Configuration: [Per-device Licensing](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/licenses/)
* Configuration: [Switch ACLs](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/switch-ac-ls/get-network-switch-access-control-lists)
* Configuration: [Switch DHCP Server Policies](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/switch-settings/update-network-switch-settings-dhcp-server-policy)
* Configuration: [Switch DSCP/COS settings](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/switch-settings/update-network-switch-settings-dscp-to-cos-mappings)

#### Enhancements

* Monitoring: [List the API requests made by an organization](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/api-usage/get-organization-api-requests) now includes `sourceIp`
* Monitoring: [Get a list of softwares associated with a device](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/sm/get-network-sm-softwares) now includes `appId`
* Configuration: [Switch MAC whitelist](https://developer.cisco.com/meraki/api/#/rest/api-endpoints/switch-ports/update-device-switch-port)
