...
`POST` /organizations/{organizationId}/claim 
	...
	add orders – The numbers of the orders that should be claimed (array)
	add serials – The serials of the devices that should be claimed (array)
	licenses - The licenses that should be claimed (array)
