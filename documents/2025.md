...
## Meraki API Release Notes v1.65.0
 [**Changelog**](https://developer.cisco.com/meraki/whats-new/v1-65-0/)
...
# 11-2025
## Meraki API Release Notes v1.64.0
 [**Changelog**](https://developer.cisco.com/meraki/whats-new/v1-64-0/)
...
- Update the OpenRoaming setting for the SSID, [updateNetworkWirelessSsidOpenRoaming](https://developer.cisco.com/meraki/api-v1/update-network-wireless-ssid-open-roaming/)
- Returns an array of objects, each containing SSID OpenRoaming configs for the corresponding network, [getOrganizationWirelessSsidsOpenRoamingByNetwork](https://developer.cisco.com/meraki/api-v1/get-organization-wireless-ssids-open-roaming-by-network/)
...
> \- property `ip6Local` added

### switch

**settings**

- Returns the switch network settings, [getNetworkSwitchSettings](https://developer.cisco.com/meraki/api-v1/get-network-switch-settings/)
- Update switch network settings, [updateNetworkSwitchSettings](https://developer.cisco.com/meraki/api-v1/update-network-switch-settings/)

> \- property `uplinkSelection` added
...
> \- property `radio` added

### organizations

**firmware**

- Get firmware upgrade status for the filtered devices, [getOrganizationFirmwareUpgradesByDevice](https://developer.cisco.com/meraki/api-v1/get-organization-firmware-upgrades-by-device/)

> \- param `limitPerDevice` added

**saml**

- List the SAML IdPs in your organization., [getOrganizationSamlIdps](https://developer.cisco.com/meraki/api-v1/get-organization-saml-idps/)
- Create a SAML IdP for your organization., [createOrganizationSamlIdp](https://developer.cisco.com/meraki/api-v1/create-organization-saml-idp/)
- Get a SAML IdP from your organization., [getOrganizationSamlIdp](https://developer.cisco.com/meraki/api-v1/get-organization-saml-idp/)
- Update a SAML IdP in your organization, [updateOrganizationSamlIdp](https://developer.cisco.com/meraki/api-v1/update-organization-saml-idp/)

> \- property `visionConsumerUrl` added

> \- property `ssoLoginUrl` added



# 10-2025
## Meraki API Release v1.63.0
 [**Changelog**](https://developer.cisco.com/meraki/whats-new/v1-63-0/)

## Summary

- 1 new operation added
- 83 operations enhanced
- 857 total operations available
...
- Return MQTT Settings for networks, [getOrganizationWirelessMqttSettings](https://developer.cisco.com/meraki/api-v1/get-organization-wireless-mqtt-settings/)
...
> \- property `serial` added

> \- property `slot` added

**accessPolicies**

- List the access policies for a switch network, [getNetworkSwitchAccessPolicies](https://developer.cisco.com/meraki/api-v1/get-network-switch-access-policies/)
- Create an access policy for a switch network, [createNetworkSwitchAccessPolicy](https://developer.cisco.com/meraki/api-v1/create-network-switch-access-policy/)
- Return a specific access policy for a switch network, [getNetworkSwitchAccessPolicy](https://developer.cisco.com/meraki/api-v1/get-network-switch-access-policy/)
- Update an access policy for a switch network, [updateNetworkSwitchAccessPolicy](https://developer.cisco.com/meraki/api-v1/update-network-switch-access-policy/)

> \- property `dataGroupPolicyId` added

> \- property `voiceGroupPolicyId` added

> \- property `dataSgtId` added

> \- property `voiceSgtId` added

> \- property `properties` added

> \- property `failedAuthGroupPolicyId` added

> \- property `failedAuthSgtId` added

> \- property `preAuthenticationGroupPolicyId` A...

> \- property `guestGroupPolicyId` added

> \- property `guestSgtId` added
...
> \- property `uacAutomaticFailback` added

> \- property `uacCandidateUplink` added
...
> \- property `radiusAccountingStartDelay` added



# 09-2025

## Dashboard API Release v1.62.0 
 [**Changelog**](https://developer.cisco.com/meraki/whats-new/v1-62-0/)

 ## Summary

- 3 new endpoints added
- 15 updated
- 855 total endpoints available
...
- Get policies for all clients with policies, [getOrganizationPoliciesAssignmentsByClient](https://developer.cisco.com/meraki/api-v1/get-organization-policies-assignments-by-client/)
...
- Returns analytics data for timespans, [getOrganizationCameraDetectionsHistoryByBoundaryByInterval](https://developer.cisco.com/meraki/api-v1/get-organization-camera-detections-history-by-boundary-by-interval/)
...
- Show VPN status for networks in an organization, [getOrganizationApplianceVpnStatuses](https://developer.cisco.com/meraki/api-v1/get-organization-appliance-vpn-statuses/)
...
> \- property `highSpeed` added

**stacks**

- List the switch stacks in a network, [getNetworkSwitchStacks](https://developer.cisco.com/meraki/api-v1/get-network-switch-stacks/)
- Show a switch stack, [getNetworkSwitchStack](https://developer.cisco.com/meraki/api-v1/get-network-switch-stack/)
- Add a switch to a stack, [addNetworkSwitchStack](https://developer.cisco.com/meraki/api-v1/add-network-switch-stack/)
- Remove a switch from a stack, [removeNetworkSwitchStack](https://developer.cisco.com/meraki/api-v1/remove-network-switch-stack/)

> \- property `virtualMac` added
...
- Return the L3 firewall rules for an SSID on an MR network, [getNetworkWirelessSsidFirewallL3FirewallRules](https://developer.cisco.com/meraki/api-v1/get-network-wireless-ssid-firewall-l-3-firewall-rules/)
- Update the L3 firewall rules of an SSID on an MR network, [updateNetworkWirelessSsidFirewallL3FirewallRules](https://developer.cisco.com/meraki/api-v1/update-network-wireless-ssid-firewall-l-3-firewall-rules/)

> \- property `ipVer` added

### organizations

**devices**

- List Packet Captures, [getOrganizationDevicesPacketCaptureCaptures](https://developer.cisco.com/meraki/api-v1/get-organization-devices-packet-capture-captures/)
