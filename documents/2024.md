...
* This release introduces **wireless LAN controller** management capabilities with a suite of new endpoints. These operations enable granular tracking of connectivity status, interface performance, and failover events. 
