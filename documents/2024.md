...
- The [vlansEnabledState](https://developer.cisco.com/meraki/api-v1/get-network-vlans-enabled-state/) endpoint for networks provides the current VLAN enabled status.
